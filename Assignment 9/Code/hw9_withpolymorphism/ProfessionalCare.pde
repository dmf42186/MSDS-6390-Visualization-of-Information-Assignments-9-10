...
class ProfessionalCare extends Graph {
  ...
  ProfessionalCare(float locx, float locy, float radius) {
  ...
  void drawBubble(float locx, float locy) {
    ...
    fill(255);
    textFont(Font1);
    text("Professional Care", 125+(width/2-125)*3/4-40, (height-100)/2-168.75+radius/2+20);
